const AnalyticsEvent = {
  ...
  FAMILY_GUIDE_VIEWED: 'family_guide_viewed',
  FAMILY_AGE_FILTER_SELECTED: 'family_age_filter_selected',
  FAMILY_QUICK_PICK_CLICKED: 'family_quick_pick_clicked',
  FAMILY_COMPARISON_USED: 'family_comparison_used',
  FAMILY_MUSEUM_DETAILS_CLICKED: 'family_museum_details_clicked',
  FAMILY_TICKET_CTA_CLICKED: 'family_ticket_cta_clicked',
  FAMILY_FAQ_OPENED: 'family_faq_opened',
  FAMILY_RELATED_CONTENT_CLICKED: 'family_related_content_clicked',
};
