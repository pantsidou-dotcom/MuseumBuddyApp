const translations = {
  en: {
    ...
    heroHighlightsAriaLabel: 'Featured Amsterdam museums',
    heroHighlightsEyebrow: 'Spotlight',
    heroHighlightsTitle: 'Featured picks',
    heroHighlightsSubtitle: 'Quick highlights to start planning your Amsterdam itinerary.',
    heroHighlightFreeTag: 'Free entry',
    heroHighlightCta: 'View details',
  ...
  nl: {
    ...
    heroHighlightsAriaLabel: 'Uitgelichte musea in Amsterdam',
    heroHighlightsEyebrow: 'In de kijker',
    heroHighlightsTitle: 'Uitgelichte tips',
    heroHighlightsSubtitle: 'Snelle inspiratie om je museumbezoek in Amsterdam te plannen.',
    heroHighlightFreeTag: 'Gratis toegang',
    heroHighlightCta: 'Bekijk details',
