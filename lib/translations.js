const translations = {
  en: {
    ...
    heroTitle: 'Discover Museums & Exhibitions',
    heroSubtitle: 'Plan your next cultural adventure with curated highlights from the Netherlands.',
    filters: 'Filters',
    filtersTitle: 'Filter results',
    filterExpositions: 'Only show museums with exhibitions',
  ...
  nl: {
    ...
    heroTitle: 'Ontdek musea & exposities',
    heroSubtitle: 'Plan je volgende culturele avontuur met zorgvuldig geselecteerde hoogtepunten.',
    filters: 'Filters',
    filtersTitle: 'Resultaten filteren',
    filterExpositions: 'Toon alleen musea met exposities',
