const translations = {
  en: {
    ...
    headerTagline: 'Your guide to Dutch museums',
    searchPlaceholder: 'Search',
    searchMuseums: 'Search museums',
    clearSearch: 'Clear search',
    filterGroupLabel: 'Filter by theme',
    filterScience: 'Science',
    filterHistory: 'History',
    filterKids: 'For kids',
    filterModernArt: 'Modern art',
  ...
  nl: {
    ...
    headerTagline: 'Jouw gids voor musea in Nederland',
    searchPlaceholder: 'Zoek',
    searchMuseums: 'Zoek musea',
    clearSearch: 'Wis zoekopdracht',
    filterGroupLabel: 'Filter op thema',
    filterScience: 'Wetenschap',
    filterHistory: 'Geschiedenis',
    filterKids: 'Voor kinderen',
    filterModernArt: 'Moderne kunst',
