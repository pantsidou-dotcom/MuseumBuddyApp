const translations = {
  en: {
    ...
    duration: 'Duration',
      ...
      museumTabOverview: 'Overview',
      museumTabExhibitions: 'Exhibitions',
      museumTabVisitorInfo: 'Visitor info',
      museumTabMap: 'Map',
      museumMapTitle: 'Map of {name}',
      museumMapUnavailable: "We couldn't load a map for this museum.",
  ...
  nl: {
    ...
    duration: 'Looptijd',
      ...
      museumTabOverview: 'Overzicht',
      museumTabExhibitions: 'Tentoonstellingen',
      museumTabVisitorInfo: 'Bezoekersinfo',
      museumTabMap: 'Kaart',
      museumMapTitle: 'Kaart van {name}',
      museumMapUnavailable: 'We konden geen kaart laden voor dit museum.',
      openInMaps: 'Open in Maps',
    privacy: 'Privacy & Cookies',
