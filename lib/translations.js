const translations = {
  en: {
    ...
    expositionFiltersTitle: 'Filter exhibitions',
    expositionFiltersDescription: 'Refine the exhibitions list with these filters.',
    expositionFiltersGroupTitle: 'Filter options',
    expositionFiltersButton: 'Filters',
    expositions: 'Expositions',
    reset: 'Reset',
    results: 'results',
    noResults: 'No results.',
    noFilteredExpositions: 'No exhibitions match the selected filters.',
  ...
  nl: {
    ...
    expositionFiltersTitle: 'Tentoonstellingen filteren',
    expositionFiltersDescription: 'Verfijn de lijst met tentoonstellingen met deze filters.',
    expositionFiltersGroupTitle: 'Filteropties',
    expositionFiltersButton: 'Filters',
    expositions: 'Exposities',
    reset: 'Reset',
    results: 'resultaten',
    noResults: 'Geen resultaten.',
    noFilteredExpositions: 'Geen tentoonstellingen komen overeen met je filters.',
