const translations = {
  en: {
    ...
    mapToggleLabel: 'Toggle between list and map view',
    mapViewList: 'List',
    mapViewMap: 'Map',
    mapNoResults: 'No locations available for the map view.',
    mapViewAriaLabel: 'Museum locations on a map',
    free: 'Free',
    view: 'View',
  ...
  nl: {
    ...
    mapToggleLabel: 'Schakel tussen lijst en kaart',
    mapViewList: 'Lijst',
    mapViewMap: 'Kaart',
    mapNoResults: 'Geen locaties beschikbaar voor de kaartweergave.',
    mapViewAriaLabel: 'Musea op de kaart',
    free: 'Gratis',
    view: 'Bekijk',
