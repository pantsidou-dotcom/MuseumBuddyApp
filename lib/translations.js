const translations = {
  en: {
    ...
    heroTagline: 'Your cultural compass',
    heroTitle: 'Plan your museum day in one glance',
    heroSubtitle:
      'See what’s open now, compare exhibitions, and save your favorites without endless searching.',
    homePrimaryCta: 'Discover museums',
    homeSecondaryCta: 'Browse exhibitions',
    homeDateLegend: 'When do you want to go?',
    homeDateToday: 'Today',
    homeDateWeekend: 'This weekend',
    ...
    exhibitionsEyebrow: 'Amsterdam exhibitions',
    exhibitionsPageSubtitle: 'Discover current exhibitions across Amsterdam museums.',
    exhibitionsFallbackMessage:
      'Live exhibition data is temporarily unavailable. Showing saved highlights instead.',
    exhibitionsHostedBy: 'On view at {museum}',
    exhibitionsPrimaryCta: 'Browse exhibitions',
    exhibitionsSecondaryCta: 'Back to museums',
    exhibitionsMoreInfoCta: 'More information',
    reset: 'Reset',
    results: 'results',
  ...
  nl: {
    ...
    heroTagline: 'Jouw cultuurkompas',
    heroTitle: 'Plan je museumdag in één oogopslag',
    heroSubtitle:
      'Zie direct wat nu open is, ontdek tentoonstellingen en stel je favorietenlijst samen zonder gedoe.',
    homePrimaryCta: 'Ontdek musea',
    homeSecondaryCta: 'Bekijk tentoonstellingen',
    homeDateLegend: 'Wanneer wil je gaan?',
    homeDateToday: 'Vandaag',
    homeDateWeekend: 'Dit weekend',
    homeOpenNow: 'Open nu',
    ...
    exhibitionsEyebrow: 'Amsterdam tentoonstellingen',
    exhibitionsPageSubtitle: 'Ontdek alle actuele tentoonstellingen in Amsterdam.',
    exhibitionsFallbackMessage:
      'Live gegevens voor tentoonstellingen zijn tijdelijk niet beschikbaar. We tonen een opgeslagen selectie.',
    exhibitionsHostedBy: 'Te zien in {museum}',
    exhibitionsPrimaryCta: 'Bekijk tentoonstellingen',
    exhibitionsSecondaryCta: 'Terug naar musea',
    exhibitionsMoreInfoCta: 'Meer informatie',
    reset: 'Reset',
    results: 'resultaten',
