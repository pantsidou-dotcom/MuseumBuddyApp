const museumSummaries = {
  'allard-pierson-amsterdam': {
    en: 'Archaeological and cultural history from ancient civilizations.',
    nl: 'Archeologische en cultuurgeschiedenis uit oude beschavingen.',
  },
  'amsterdam-museum-amsterdam': {
    en: 'Stories of Amsterdam\'s past, present and future.',
  ...
  'hart-museum-amsterdam': {
    en: 'Art and stories about the human heart.',
    nl: 'Het H’ART Museum (in het 17e-eeuwse Amstelhof aan de Amstel) toont grote, wisselende kunsttentoonstellingen van internationale topcollecties en huisvest ook het Amsterdam Museum aan de Amstel.',
  },
  'het-grachtenmuseum-amsterdam': {
    en: 'Canal house museum explaining Amsterdam\'s waterways.',
    nl: 'Grachtenpandmuseum dat de waterwegen van Amsterdam uitlegt.',
  },
  'het-schip-amsterdam': {
    en: 'Amsterdam School architecture in workers housing.',
    nl: 'Amsterdamse School architectuur in arbeiderswoningen.',
  },
  'huis-marseille-amsterdam': {
    en: 'Photography in a historic canal house.',
    nl: 'Fotografie in een historisch grachtenpand.',
  },
  'joods-museum-amsterdam': {
    en: 'Jewish history and culture in the Netherlands.',
    nl: 'Joodse geschiedenis en cultuur in Nederland.',
  },
  'kattenkabinet-amsterdam': {
    en: 'Art dedicated to cats and cat lovers.',
    nl: 'Kunst gewijd aan katten en kattenliefhebbers.',
  },
  'micropia-museum-amsterdam': {
    en: 'World of microbes and invisible life.',
  ...
  'woonbootmuseum-amsterdam': {
    ...
    nl: 'Leven op de woonboten van Amsterdam.',
  },
};
